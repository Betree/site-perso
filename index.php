    ...
    <div id="slide1" class="slide ">
        <div class="content">
            ...
            <p class="description" itemscope itemtype="http://data-vocabulary.org/Person">
                My name is <span itemprop="name">Benjamin Piouffle</span>. I'm a French student about to graduate at the French school
                <span itemprop="affiliation"><b>Epitech</b></span>.
                I studied computer science for three years at <b>Epitech in Marseille (France)</b>, one year at
                <span itemprop="affiliation">
                    <b>California State University of
                        <span itemprop="address" itemscope itemtype="http://data-vocabulary.org/Address">
                            <span itemprop="locality">Long Beach</span> (USA)
                        </span>
                    </b>
                </span>
                and I'm living in Paris for my final year.
                <br><br>
                I have also worked as a
                <span itemprop="title">developer</span>
                for two IT companies along with my studies for more than a year.<br><br>
        ...
        <div class="content">
            ...
            <div class="description">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        <img class="skillLogo" height="75px" src="img/icons_skills/ruby-on-rails.png" title="Ruby On Rails" alt="Ruby On Rails">
                        ...
                        <img class="skillLogo" height="75px" src="img/icons_skills/coffeescript.png" title="Coffeescript" alt="Coffeescript">
    ...
    <div id="slide6" class="slide">
        <div class="content">
            ...
            <div class="description_container">
                ...
                <div class="row hidden" id="emailFormContainer">
                    <div class="formContainer">
                        <form method="POST">
                            ...
                            <input type="email" name="email" placeholder="Your email" size="40" required autofocus="autofocus" value="<?php if ($contactForm) echo $contactForm->getFieldValueIfItExist("email"); ?>"/><br>
                            <textarea name="message" placeholder="Your message" rows="12" cols="70" required pattern=".{20,10000}" required title="Your message must be 20 to 10000 characters"><?php if ($contactForm) echo $contactForm->getFieldValueIfItExist("message"); ?></textarea><br>
                ...
                <div class="row">
                    <a href="https://plus.google.com/+BenjaminPiouffle" target="_BLANK"><img src="img/icons_social/googleplus.png" class="contactIcon" title="Google+" alt="Google+"></a>
